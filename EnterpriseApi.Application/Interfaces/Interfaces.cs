...
public interface IInventoryRepository
{
    ...
    Task<Inventory?> GetByProductIdForUpdateAsync(Guid productId, CancellationToken ct = default);
...
public interface IOrderRepository
{
    ...
    Task<PagedResult<Order>> GetAllAsync(int page, int pageSize, string? status = null, CancellationToken ct = default);
...
public interface IInvoiceRepository
{
    ...
    Task<PagedResult<Invoice>> GetByUserIdAsync(Guid userId, int page, int pageSize, CancellationToken ct = default);
...
{
    Task<PagedResult<AuditLog>> GetByEntityAsync(string entityName, string entityId, int page, int pageSize, CancellationToken ct = default);
...
// Unit of Work
// Coordinates multiple repository operation in a single database transaction
// CRITICAL: Call SaveChangesAsync() ONCE per transaction to ensure all operations are committed together
...
public interface IProductService
{
    ...
    Task<PagedResult<ProductDto>> GetAllAsync(int page, int pageSize, string? category = null, CancellationToken ct = default);
    Task<ProductDto> CreateAsync(CreateProductRequest request, CancellationToken ct = default);
    Task<ProductDto> UpdateAsync(Guid id, UpdateProductRequest request, CancellationToken ct = default);
    Task<ProductDto> ApplyDiscountAsync(Guid id, ApplyDiscountRequest request, CancellationToken ct = default);
...
public interface IOrderService
{
    ...
    Task<PagedResult<OrderDto>> GetByUserIdAsync(Guid userId, int page, int pageSize, CancellationToken ct = default);
    Task<PagedResult<OrderDto>> GetAllAsync(int page, int pageSize, string? status = null, CancellationToken ct = default);
    Task<OrderDto> CancelOrderAsync(Guid id, CancelOrderRequest request, CancellationToken ct = default);
...
public interface IInvoiceService
{
    ...
    Task<PagedResult<InvoiceDto>> GetByUserIdAsync(Guid userId, int page, int pageSize, CancellationToken ct = default);
    Task<InvoiceDto> PayInvoiceAsync(Guid id, PayInvoiceRequest request, CancellationToken ct = default);
...
public interface INotificationService
{
    ...
    Task<PagedResult<NotificationDto>> GetByUserIdAsync(Guid userId, int page, int pageSize, CancellationToken ct = default);
...
public interface IEventPublisher
{
    ...
    Task PublishManyAsync<TEvent>(IEnumerable<TEvent> domainEvents, CancellationToken ct = default) where TEvent : DomainEvent;
}

// CurrentUserContext
// Wraps IHttpContextAccessor to provide strongly-typed access to the current user's ID and role.
